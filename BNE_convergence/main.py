...
parser.add_argument('--run_split_num', default=1, type=int, help='run N different split times')
parser.add_argument('--run_init_num', default=1, type=int, help='run N different init seeds')
...
if __name__ == '__main__':
    ...
    if args.size_imb_type == 'step':
        ecs = [1] # ec==0, use original imbalanced data
    else:
        ecs = [1, 1.5, 2, 2.5, 3]
    results = []
    for lr in lrs:

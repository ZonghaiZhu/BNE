...
def main(args):
    ...
    for iter_split_seed in range(args.run_split_num):
        ...
        train_feats, valid_feats, test_feats, train_labels, valid_labels, test_labels, process_time = \
        ...
        for iter_init_seed in range(args.run_init_num):
            ...
            used_time = time.time() - start_time + process_time
    ...
    return val_weighted_np, val_macro_np, weighted_np, macro_np, time_np
    ...
    for lr in lrs:
        for wd in wds:
            for ec in ecs:
                ...
                args.ec = ec
                val_weighted_np, val_macro_np, weighted_np, macro_np, run_time = main(args)

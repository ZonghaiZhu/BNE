...
parser.add_argument('--data_name', default='photo', type=str, help="data name")  # cora citeseer pubmed photo computers
...
# Imb_loss
parser.add_argument('--loss_name', default="cb-softmax", type=str, help="the training loss")  # ce focal re-weight cb-softmax
